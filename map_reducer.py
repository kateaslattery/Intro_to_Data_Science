...
def mapper():
    ...
    for line in sys.stdin:
        data = line.strip().split(",") #strips each line of data on the comma
        if len(data) != 12 or data[0] == 'Registrar': #continue if word is less than 12 ch or not in the header row
          continue
        print "{0}\t{1}".format(data[3], data[8]) #print district and # of aadhar generated separated by a tab
